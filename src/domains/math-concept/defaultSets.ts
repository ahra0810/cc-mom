...
export const MATH_CONCEPT_DEFAULT_SETS: QuestionSet[] = [
  {
    ...
    meta: {
      ...
      relatedTermsDetailed: [
        { emoji: '🔺', term: '꼭짓점', desc: '두 변이 만나는 뾰족한 점. 삼각형은 꼭짓점 3개!' },
        { emoji: '⬜', term: '도형', desc: '점·선·면이 모여 만든 모양. 변은 도형의 일부예요.' },
        { emoji: '⬠', term: '다각형', desc: '변이 3개 이상인 곧은 선 도형. 삼·사·오각형 등.' },
      ],
  ...
  },
  {
    ...
    meta: {
      ...
      relatedTermsDetailed: [
        { emoji: '🟦', term: '넓이', desc: '도형 안쪽 공간의 크기. 둘레는 바깥, 넓이는 안!' },
        { emoji: '📏', term: '변', desc: '도형을 이루는 곧은 선분. 둘레는 모든 변의 합.' },
        { emoji: '🔺', term: '꼭짓점', desc: '두 변이 만나는 점. 직사각형은 4개.' },
      ],
  ...
  },
  {
    ...
    meta: {
      ...
      relatedTermsDetailed: [
        { emoji: '🔵', term: '홀수', desc: '둘로 나누면 1이 남는 수. 1, 3, 5, 7, 9 …' },
        { emoji: '✖️', term: '배수', desc: '어떤 수를 곱해 만든 수. 짝수 = 2의 배수!' },
        { emoji: '🔢', term: '자연수', desc: '1부터 시작하는 셈수. 짝수·홀수는 자연수의 두 짝.' },
      ],
